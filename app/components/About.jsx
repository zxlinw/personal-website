...
const About = () => {
    ...
    const data_arr = [
        (
            <ul key="languages" className="my-3">
        ...
        <div className="md:grid md:grid-cols-2 gap-8  py-8 px-4 xl:gap-16 sm:py-16 xl:px-16 ">
            ...
            <div>
                ...
                <p className="text-base lg:text-lg">
                    I am currently a student in my 2A term at the University of Waterloo studying Computer Science.  I am interested in web development and UI/UX design, but would love to get to explore other areas of tech!
                </p>
